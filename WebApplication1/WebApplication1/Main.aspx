        ...
        <div id="mainBody"> 
            ...
            <asp:Table style="margin-right:auto; margin-left:auto; text-align:center" Width="50%" ID="orderTable" CellPadding="10" runat="server">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:Button ID="rememberBtn" runat="server" Text="Remember Me" CssClass="btnRemember" OnClick="btnRemember_Click" />
                    </asp:TableCell>
                </asp:TableRow>
...
<%--                <asp:TableRow>
            ...
            <asp:Button ID="btnOrder" runat="server" CssClass="btnOrder" Text="ORDER" OnClick="btnOrder_Click" />
